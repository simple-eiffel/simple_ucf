...
extern EIF_TYPED_VALUE F93_1520(EIF_REFERENCE);
...
RTOID (F93_1520)
EIF_TYPED_VALUE F93_1520 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 92, Current, 0, 0, 1568);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(92, Current, 1568);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);

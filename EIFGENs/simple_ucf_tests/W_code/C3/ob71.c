...
extern EIF_TYPED_VALUE F71_1307(EIF_REFERENCE);
...
EIF_TYPED_VALUE F71_1307 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 70, Current, 0, 0, 1366);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(70, Current, 1366);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80003B4, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,948,0xFF01,0,0xFFFF};
		EIF_TYPE typres0;

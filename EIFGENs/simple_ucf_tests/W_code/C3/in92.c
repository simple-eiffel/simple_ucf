...
extern EIF_TYPED_VALUE F92_1516(EIF_REFERENCE);
extern EIF_TYPED_VALUE F92_1517(EIF_REFERENCE);
extern EIF_TYPED_VALUE F92_1518(EIF_REFERENCE);
extern void F92_1519(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F92_1516 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 91, Current, 1, 0, 1565);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1431, dtype))(Current, up1x);
	RTHOOK(3);
...
RTOID (F92_1517)
EIF_TYPED_VALUE F92_1517 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 91, Current, 0, 0, 1566);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
RTOID (F92_1518)
EIF_TYPED_VALUE F92_1518 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 91, Current, 0, 0, 1567);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F92_1519 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 91, Current, 0, 1, 1564);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(91, Current, 1564);

...
extern EIF_TYPED_VALUE F120_1614(EIF_REFERENCE);
extern EIF_TYPED_VALUE F120_1615(EIF_REFERENCE);
...
EIF_TYPED_VALUE F120_1614 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 119, Current, 0, 0, 1662);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1596, 136))(Current)).it_i4);
...
RTOID (F120_1615)
EIF_TYPED_VALUE F120_1615 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 119, Current, 0, 0, 1663);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;

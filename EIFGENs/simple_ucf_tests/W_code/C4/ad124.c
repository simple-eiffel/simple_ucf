...
extern EIF_TYPED_VALUE F124_1624(EIF_REFERENCE);
extern EIF_TYPED_VALUE F124_1625(EIF_REFERENCE);
...
EIF_TYPED_VALUE F124_1624 (EIF_REFERENCE Current)
{
	GTCX
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1603, 136))(Current)).it_i4);
...
RTOID (F124_1625)
EIF_TYPED_VALUE F124_1625 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 123, Current, 0, 0, 1673);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;

...
extern EIF_TYPED_VALUE F62_1137(EIF_REFERENCE);
extern EIF_TYPED_VALUE F62_1138(EIF_REFERENCE);
extern EIF_TYPED_VALUE F62_1139(EIF_REFERENCE);
...
EIF_TYPED_VALUE F62_1137 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F62_1138 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F62_1139 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 61, Current, 0, 0, 1195);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(61, Current, 1195);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(1051, "fractional_second", tr1));

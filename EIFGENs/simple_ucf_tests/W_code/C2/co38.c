...
extern EIF_TYPED_VALUE F38_837(EIF_REFERENCE);
extern EIF_TYPED_VALUE F38_838(EIF_REFERENCE);
extern EIF_TYPED_VALUE F38_839(EIF_REFERENCE);
extern EIF_TYPED_VALUE F38_840(EIF_REFERENCE);
...
RTOID (F38_837)
EIF_TYPED_VALUE F38_837 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(3858, Dtype(tr1)))(tr1, ui4_1x);
	RTNHOOK(1,1);
	...
	tr1 = RTMS_EX_H("65000",5,892765232);
	ur1 = tr1;
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(294, 13))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur2 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(3071, "put", Result))(Result, ur1x, ur2x);
	RTHOOK(153);
...
RTOID (F38_838)
EIF_TYPED_VALUE F38_838 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 37, Current, 0, 0, 941);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
RTOID (F38_839)
EIF_TYPED_VALUE F38_839 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 37, Current, 0, 0, 942);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(37, Current, 942);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF80003E0, 0,0); /* Result */
...
RTOID (F38_840)
EIF_TYPED_VALUE F38_840 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 37, Current, 0, 0, 943);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(37, Current, 943);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF80003E0, 0,0); /* Result */

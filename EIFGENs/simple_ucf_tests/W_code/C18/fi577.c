...
extern EIF_TYPED_VALUE F577_3497(EIF_REFERENCE);
extern void F577_7107(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F577_3497 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 576, Current, 0, 0, 4027);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(576, Current, 4027);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F577_7107 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 576, Current, 0, 7106);
	RTSA(dtype);
	RTME(dtype, 0);

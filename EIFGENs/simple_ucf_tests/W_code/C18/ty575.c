...
extern EIF_TYPED_VALUE F575_4185(EIF_REFERENCE);
...
EIF_TYPED_VALUE F575_4185 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 574, Current, 0, 0, 6371);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(574, Current, 6371);
	RTIV(Current, RTAL);

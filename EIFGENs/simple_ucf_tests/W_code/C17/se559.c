...
extern EIF_TYPED_VALUE F559_3454(EIF_REFERENCE);
...
EIF_TYPED_VALUE F559_3454 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 558, Current, 0, 0, 3926);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(558, Current, 3926);
	RTIV(Current, RTAL);
	RTHOOK(1);

...
extern EIF_TYPED_VALUE F429_3497(EIF_REFERENCE);
extern void F429_7107(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F429_3497 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 428, Current, 0, 0, 4019);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(428, Current, 4019);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F429_7107 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 428, Current, 0, 7106);
	RTSA(dtype);
	RTME(dtype, 0);

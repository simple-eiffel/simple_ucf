...
extern EIF_TYPED_VALUE F391_3497(EIF_REFERENCE);
extern void F391_7107(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F391_3497 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 390, Current, 0, 0, 4017);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(390, Current, 4017);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F391_7107 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 390, Current, 0, 7106);
	RTSA(dtype);
	RTME(dtype, 0);

...
#ifndef INLINE_F182_3035
static EIF_NATURAL_64 inline_F182_3035 (EIF_POINTER arg1)
{
	#ifdef EIF_WINDOWS
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 181, Current, 1, 1, 3100);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	up1 = arg1;
	tu8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2689, dtype))(Current, up1x)).it_n8);
...
body:;
	Result = inline_F182_3035 ((EIF_POINTER) arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;

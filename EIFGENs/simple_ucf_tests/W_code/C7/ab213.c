...
extern EIF_TYPED_VALUE F213_4369(EIF_REFERENCE);
extern void F213_7127(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F213_4369 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 212, Current, 0, 0, 7370);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(212, Current, 7370);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F213_7127 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 212, Current, 0, 7126);
	RTSA(dtype);
	RTME(dtype, 0);

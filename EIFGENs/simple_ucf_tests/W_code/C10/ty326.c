...
extern EIF_TYPED_VALUE F326_4185(EIF_REFERENCE);
...
EIF_TYPED_VALUE F326_4185 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 325, Current, 0, 0, 6366);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(325, Current, 6366);
	RTIV(Current, RTAL);
